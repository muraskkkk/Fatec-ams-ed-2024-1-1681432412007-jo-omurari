...
void inicializarFila(Atendimento *fila) {
    fila->inicio = 0;
    fila->fim = -1;
}

int filaVazia(Atendimento *fila) {
    return (fila->fim < fila->inicio);
}

void adicionarPaciente(Atendimento *fila, Paciente paciente) {
...
void removerPaciente(Atendimento *fila) {
    if (!filaVazia(fila)) {
...
void atenderPacientes(Atendimento *filaN, Atendimento *filaP, Atendimento *filaU, int n) {
    int count = 0;
...
void mostrarFila(Atendimento *fila) {
...
void cadastrarPaciente(Atendimento *filaN, Atendimento *filaP, Atendimento *filaU) {
...
int main() {
    Atendimento filaNormal, filaPrioritaria, filaUrgente;
